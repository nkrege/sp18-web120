...
$toName = "Nicholas Krege"; //place your client's name here
$website = "Big Web 120";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
?>
    ...
    <div>
        <label>
			Company Name:<br /><input type="text" name="Name" placeholder="Company Name" title="Company Name" tabindex="10" size="44" autofocus />
		</label>    
    </div>
    <div>
        <label>
			Address 1:<br /><input type="text" name="Address 1" required="required" placeholder="Address (required)" title="Address is required" tabindex="10" size="44" autofocus />
		</label>    
    </div>
    <div>
        <label>
			Address 2:<br /><input type="text" name="Address 2" placeholder="Address 2" title="Address 2" tabindex="10" size="44" autofocus />
		</label>
    </div>
    <div>
        <label>
			City, State, Zip:<br /><input type="text" name="City State Zip" required="required" placeholder="City, State Zip (required)" title="City State Zip is required" tabindex="10" size="44" autofocus />
		</label>
    </div>
    <div>
        <label>
    ...
    <div>	
		<label>
			What does your company do?<br /><textarea name="Comments" cols="36" rows="4" required="required" placeholder="What does your company do?" tabindex="60"></textarea>
		</label>
	</div>
    <div>	
		<label>
			Do you have a URL? If so, what? If not, what do you want it to be?<br /><input type="text" name="URL" required="required" title="Do you have a URL?" placeholder="URL?" tabindex="20" size="44" />
		</label>
	</div>
